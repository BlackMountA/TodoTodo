...
class App {
        ...
        const html = `<div class="flex justify-between items-center">
                <div>
                    <div class=" flex  gap-3 items-start   ">
                        ...
                        <p class="align-middle">${addTaskTitle.value}</p>
                    </div>
                    <p class="ml-7 text-sm text-teal-700 ">${addTaskDescription.value}</p>
                </div>
    ...
    _clearActive() {
        ...
        active.title.splice(0)
        active.description.splice(0)
        // updateUI(user)
    }
    _clearCompleted() {
